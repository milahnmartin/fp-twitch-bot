...
client.on('message', (channel, userstate, message, self) => {
    ...
    if (command[0] === '!') {
        (0, logs_1.create_twitch_log)(userstate.username, user_response[0], user_response[1]);
        (0, logs_1.create_twitch_log_discord)(userstate.username, user_response[0], user_response[1]);
    }
    ;
